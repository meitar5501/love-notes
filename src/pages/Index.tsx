...
const loveNotes: LoveNote[] = [
  ...
  },
  {
    id: 6,
    title: "סתם ככה",
    message: "בלי סיבה מיוחדת—רק רציתי להזכיר לך שאת אהובה, יקרה ומעריכה. את מביאה כל כך הרבה שמחה ואור לחיים שלי, ואני אסיר תודה על כל רגע איתך. את האדם האהוב עליי ביותר.",
    emoji: "💖"
  },
  {
    id: 7,
  ...
  },
  {
    ...
    message: "אני אוהב אותך יותר ממה שאת יכולה לדמיין. האהבה שלי אלייך היא אינסופית, ללא תנאים, ללא גבולות. את הכי חשובה לי בעולם, ואני אעשה הכל כדי שתרגישי אהובה ומאושרת.",
    emoji: "💝"
  },
  {
    id: 19,
  ...
  },
  {
    ...
    message: "אין עוד מישהי כמוך בעולם. את אחת ויחידה, מיוחדת במינה, יקרה מפז. כל יום שאני מכיר אותך יותר, אני מבין כמה את מיוחדת. תודה לך על כך שאת מי שאת, תודה לך על כך שאת את.",
    emoji: "🦋"
  }
];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12 animate-fade-in-up">
          ...
          <p className="font-body text-lg md:text-xl text-[hsl(340,25%,50%)] max-w-2xl mx-auto">
            פתחי כשהלב שלך צריך תזכורת שאת אהובה
          </p>
        </div>
        ...
        <div className="text-center mt-12 animate-fade-in-up">
          <p className="font-body text-sm text-[hsl(340,25%,50%)]">
            נעשה באהבה <Heart className="inline h-4 w-4 text-[hsl(345,75%,70%)] fill-[hsl(345,75%,70%)]" /> בשבילך
          </p>
        </div>
      </div>
    </div>
